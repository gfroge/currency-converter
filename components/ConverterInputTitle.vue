<template>
  ...
  >
    <v-card-title class="font-weight-light" :style="(w<600)?'font-size: 28px':'font-size: 32px'">
      Введите запрос 
    </v-card-title>
    ...
    <ValidationObserver ref="observer">
      ...
      <v-container
        :class="(w<600)?'d-flex flex-column px-0 pr-2  align-center':'d-flex px-9 justify-center'">
        ...
        <div style="max-width: 214px" :class="(w<600)?'d-flex justify-space-between pr-0 mb-4':'d-flex justify-space-between pr-5'">
